...
import { Users, BookOpen, UserX, MessageSquare } from 'lucide-react';
import { StatistiqueAC } from '../types';

interface StatCardACProps {
    stat: StatistiqueAC;
}
...
export default function StatCardAC({ stat }: StatCardACProps) {
